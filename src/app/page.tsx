              ...
              <form onSubmit={handleSubmit} className="mx-auto max-w-md">
                <div className="flex gap-3">
                  <input
                    ...
                    className="flex-1 rounded-full px-6 py-4 text-sm font-light text-white/80 placeholder-white/30 outline-none backdrop-blur-sm transition-all duration-500 focus:shadow-[0_0_30px_rgba(196,149,106,0.06)]"
                    style={{
